...
class PlansProvider extends ChangeNotifier {
  ...
  static final List<Plan> _staticList =  [
    Plan(label: 'Bíblia em 1 ano', description: 'Leia a Bíblia em 1 ano', imgPath: 'assets/images/santidade.png', planType: PlanType.oneYear, duration: 397, qtdChapters: 3),
    Plan(label: 'Bíblia toda em 3 meses', description: 'Leia a Bíblia em 3 meses', imgPath: 'assets/images/santidade.png', planType: PlanType.threeMonths, duration: 92, qtdChapters: 13),
    Plan(label: 'Novo testamento em 2 meses', description: 'Leia o novo testamento em 2 meses', imgPath: 'assets/images/santidade.png', planType: PlanType.twoMonthsNew, duration: 66, qtdChapters: 4, isNewTestament: true),
    Plan(label: 'Antigo testamento em 6 meses', description: 'Leia o antigo testamento em 6 meses', imgPath: 'assets/images/santidade.png', planType: PlanType.sixMonthsOld, duration: 186, qtdChapters: 5, bibleLength: 39),
  ];
