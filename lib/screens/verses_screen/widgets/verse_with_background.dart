                          ...
                          children: [
                            IconButton(
                              onPressed: () {
                                ...
                                versesProvider.shareImageAndText(globalKey);
                              },
                                ...
                                if(index == 0) {
                                  return NewImageContainer(
                                    width: width,
                                      onTap: () => setState(() {
                                        futureBackground = service.getRandomImage()
                                          .whenComplete(() => _selectedColor = null);
                                      })
                                  );
                                }
                                if(index == 9) {
...
class AddMoreContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      height: width * .17,
      color: Colors.white,
      child: IconButton(onPressed: onTap, icon: const Icon(Icons.add)),
    );
  }
}
