...
class ReportDialog extends StatelessWidget {
  ...
  const ReportDialog(
      {super.key, required this.devocionalId, required this.comentario});
            ...
            onPressed: () {
              if (_formKey.currentState!.validate()) {
                final report = Report(
                    ...
                    reportReason:
                        ReportReason.fromInt(_selectedReason).description,
...
class _ReportReasonsListState extends State<ReportReasonsList> {
  ...
  void scrollToTextField() async =>
      await Scrollable.ensureVisible(_textFieldKey.currentContext!,
          duration: const Duration(milliseconds: 500));

  @override
  Widget build(BuildContext context) {
    // Flutter 3.32 moveu groupValue/onChanged do Radio para um RadioGroup
    // ancestral, que passa a ser o dono da seleção.
