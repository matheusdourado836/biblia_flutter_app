...
class _AnnotationsScreenState extends State<AnnotationsScreen> {
  ...
  void initState() {
    ...
    if(versesProvider.listaAnnotationsDb.isEmpty) {
            ...
            builder: (context, value, _) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final bookInfo = list
                      .where((element) => removerAcentos(element['name']) == annotation.book)
                      .toList();
                      ...
                      child: Card(
                        child: Slidable(
                                    ...
                                    builder: (BuildContext context) {
                                      return AlertDialog(
                                        ...
                                        actions: [
                                          TextButton(
                                            onPressed: () {
                                              value.deleteAnnotation(value.listaAnnotationsDb[index].annotationId)
                                                .then((res) => {
                                                  value.refresh(),
                                                  Navigator.pop(context)
                                                });
                          ...
                          endActionPane: ActionPane(
                            ...
                            children: [
                              SlidableAction(
                                onPressed: (context) => Share.share('Veja que interessante essa reflexão:\n${annotation.title} ${annotation.content}'),
                                icon: Icons.share,
                                label: 'Share',
                              ...
                              SlidableAction(
                                ...
                                onPressed: (context) => value.copyText(annotation.book, annotation.content, annotation.chapter, annotation.verseEnd!),
                                icon: Icons.copy,
                                label: 'Copiar',
                            ...
                            child: Column(
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Text(annotation.title, style: Theme.of(context).textTheme.titleLarge),
                                    TextButton(
                                      onPressed: (() {
                                ...
                                Container(
                                  ...
                                  child: Text(annotation.content, style: Theme.of(context).textTheme.bodyLarge),
                                )
                              ],
                            ),
                          ),
